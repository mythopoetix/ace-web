    ...
    <>
      ...
      <main className="pt-16">
        ...
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="glass rounded-xl p-8 md:p-10 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-10 relative">
                <div>
                ...
                <div className="space-y-4 flex flex-col justify-center">
                  {[
                    { icon: Clock, before: "Week of dev work", after: "Afternoon", color: "var(--authority)" },
                    { icon: TrendingUp, before: "$20K brand strategy", after: "Hours", color: "var(--capacity)" },
                    { icon: Zap, before: "Full content team", after: "Runs in parallel", color: "var(--expansion)" },
                    { icon: Clock, before: "Analysis in days", after: "Overnight", color: "var(--authority)" },
                  ].map((item, i) => {
                    const Icon = item.icon;
                    return (
                      <div key={i} className="flex items-center gap-3">
                        <span className="text-xs text-[var(--text-dim)] line-through flex-1 text-right">{item.before}</span>
                        <div className="w-6 h-6 rounded-md flex items-center justify-center shrink-0" style={{ backgroundColor: `color-mix(in srgb, ${item.color} 10%, transparent)` }}>
                          <ArrowRight size={12} style={{ color: item.color }} strokeWidth={2} />
                        </div>
        ...
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="glass rounded-xl p-8 md:p-10 relative overflow-hidden">
              ...
              <h2 className="font-heading text-2xl md:text-3xl font-semibold mb-8 relative">
              ...
              <div className="space-y-6 relative">
                {[
                  ...
                  { icon: Phone, time: "9 AM", action: "On a call", desc: "Meanwhile — newsletter drafted in your voice, emails processed, agents scanning Reddit, dashboard updated. All in parallel.", color: "var(--capacity)" },
                  ...
                  { icon: Flame, time: "2 PM", action: "Running hot", desc: "ACE catches the pattern — 10 days without rest. Doesn't push harder. Asks: \"What are you avoiding?\"", color: "var(--authority)" },
                  { icon: Moon, time: "6 PM", action: "/eod", desc: "Logs what shipped, captures patterns, surfaces the decision you've been sitting on. Seeds tomorrow.", color: "var(--capacity)" },
                ].map((item, i) => {
                  const Icon = item.icon;
                  return (
                    <div key={i} className="flex gap-5">
                      <div className="w-12 shrink-0 text-right flex flex-col items-end gap-1">
                        <Icon size={14} style={{ color: item.color, opacity: 0.6 }} strokeWidth={1.5} />
            ...
            <div className="glass rounded-xl overflow-hidden">
              <div className="grid grid-cols-1 md:grid-cols-3">
                {[
                  ...
                  { icon: Pen, title: "Writes in your voice", desc: "Your cadence, your warmth, your edge. Emails, newsletters, proposals.", color: "var(--expansion)" },
                  ...
                  { icon: Link2, title: "Connects every tool", desc: "Gmail, Calendar, Fathom, Telegram, Stripe, Airtable. One layer.", color: "var(--capacity)" },
                  ...
                  { icon: RefreshCw, title: "Evolves every week", desc: "New skills pushed automatically. Gets smarter while you sleep.", color: "var(--expansion)" },
                ].map((item, i) => {
                  const Icon = item.icon;
                  return (
                    <div
                      key={item.title}
                      className={`p-6 hover:bg-[rgba(140,120,255,0.03)] transition-colors group ${
                    ...
                    >
                      <div className="flex items-center gap-2.5 mb-2">
                        <div
                          ...
                          style={{
                            ...
                            boxShadow: `0 0 0 1px color-mix(in srgb, ${item.color} 15%, transparent)`,
                          }}
                        >
                      ...
                      <p className="text-xs text-[var(--text-secondary)] leading-relaxed pl-[38px]">{item.desc}</p>
                    </div>
                  );
                })}
              </div>
        ...
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            {/* Triad */}
            <div className="glass rounded-xl overflow-hidden mb-16 relative">
              {/* Subtle center glow */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 relative">
                {[
                  { icon: Eye, name: "Authority", tagline: "You know who you are.", signals: "Truth → Choice → Expression", desc: "The system reads whether your life matches your truth.", color: "var(--authority)" },
                  ...
                  { icon: Rocket, name: "Expansion", tagline: "You expand into what's next.", signals: "Rhythm → Containers → Realization", desc: "Structure that produces without consuming you.", color: "var(--expansion)" },
                ].map((p, i) => {
                  const Icon = p.icon;
                  return (
                    <div
                      ...
                      <div className="flex items-center gap-2.5 mb-3">
                        <div
                          ...
                          style={{
                            ...
                            boxShadow: `0 0 12px color-mix(in srgb, ${p.color} 8%, transparent), 0 0 0 1px color-mix(in srgb, ${p.color} 15%, transparent)`,
                          }}
                        >
                          <Icon size={15} style={{ color: p.color }} strokeWidth={1.5} />
                        </div>
        ...
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="max-w-2xl mb-20">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span key={label} className="flex items-center gap-1.5 font-mono text-[8px] uppercase tracking-[1.5px] text-[var(--text-dim)] border border-[var(--border)] rounded px-2.5 py-1">
            ...
            <div className="glass rounded-xl p-8 md:p-10 relative overflow-hidden">
              ...
              <h2 className="font-heading text-xl md:text-2xl font-semibold mb-2 relative">
                4 weeks. Zero to operational.
              </h2>
              <p className="text-sm text-[var(--text-secondary)] mb-8 relative">
                ...
                {[
                  ...
                  <div key={item.title}>
                    <div className="flex items-center gap-2 mb-1.5">
                      <div className="w-[5px] h-[5px] rounded-full" style={{ backgroundColor: item.color, boxShadow: `0 0 4px ${item.color}` }} />
        ...
        <section className="py-24 px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="glass rounded-xl p-8 md:p-10 text-center relative overflow-hidden">
              <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse at 50% 40%, rgba(136,120,255,0.05), transparent 60%)" }} />
